...
import { faEye, faFileCircleCheck, faCircleXmark, faChartSimple } from "@fortawesome/free-solid-svg-icons";
...
const AdminNavbar = () => {
    ...
    return (
        <div className="side-container">
            ...
            <Link to="/admin/accepted-requests">
            <div className={`dashboard ${selectedItem === 'accepted request' ? 'selected' : ''}`} onClick={() => handleItemClick('accepted request')}>
                <div className="dashboard-heading">
            ...
            <br></br>
            <Link to="/admin/rejected-requests">
            <div className={`dashboard ${selectedItem === 'rejected request' ? 'selected' : ''}`} onClick={() => handleItemClick('rejected request')}>
                <div className="dashboard-heading">
